<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePrincipal.Master" AutoEventWireup="true" CodeBehind="usuarios.aspx.cs" Inherits="ServiceDeskWEB.usuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSourceUsuario" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        DeleteCommand="DELETE FROM [Usuario] WHERE [Email] = @Email" 
        InsertCommand="INSERT INTO [Usuario] ([Senha], [Nome], [Email]) VALUES (@Senha, @Nome, @Email)" 
        SelectCommand="SELECT [Senha], [Nome], [Email] FROM [Usuario]" 
        UpdateCommand="UPDATE [Usuario] SET [Senha] = @Senha, [Nome] = @Nome WHERE [Email] = @Email">
        <DeleteParameters>
